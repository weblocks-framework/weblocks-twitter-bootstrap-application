...
function showDialog(title, body, cssClass){
  ...
  var dialogHtml = '<div style="width:600px;" class="modal fade ' + cssClass + '">' + titleBar + dialogBody + '</div>';
  ...
  // Timeout is needed for modal animation
  setTimeout(applySubmitClickEvent, 1000);
}
