...
(defun bootstrap-navbar-menu-wt (&rest args &key menu-id menu-header menu-content menu-empty-p menu-empty-message menu-ordered-list-p)
  (with-html-to-string
    (:div :class "navbar" 
     :id menu-id
...
(deftemplate :bootstrap-navbar-menu-wt 'bootstrap-navbar-menu-wt)
 
(defun bootstrap-navbar-menu-item-wt (&rest args &key item-id pane-class span-class content target-is-function pane-selected-or-disabled item-href)
  (with-html-to-string
...
(deftemplate :bootstrap-navbar-menu-item-wt 'bootstrap-navbar-menu-item-wt)
...
(defmethod render-navigation-menu :around ((obj bootstrap-navbar-navigation) &rest args &key menu-args &allow-other-keys)
  ...
  (apply #'render-menu (navigation-menu-items obj)
         ...
         :menu-template #'bootstrap-navbar-menu-wt
         :item-template  #'bootstrap-navbar-menu-item-wt
         menu-args))
